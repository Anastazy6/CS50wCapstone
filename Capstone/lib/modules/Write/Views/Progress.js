...
export const Progress = function () {
  ...
  const _setProgressArias = values => {
    let pairs = [[correctFull, values.correct], [incorrectFull, values.incorrect], [remainingFull, values.remaining]];
    pairs.forEach(pair => {
  ...
  const _setEmptyArias = values => {
    let pairs = [[correctEmpty, values.correct], [incorrectEmpty, values.incorrect], [remainingEmpty, values.remaining]];
    pairs.forEach(pair => {
